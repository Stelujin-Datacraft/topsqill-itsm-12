...
export const themes: AppTheme[] = [
  ...
  },
  {
    ...
    primary: '37 62% 88%',
    primaryForeground: '37 50% 20%',
    accent: '43 64% 69%',
    accentForeground: '37 50% 18%',
    background: '37 50% 96%',
    foreground: '37 40% 14%',
    card: '0 0% 100%',
    ...
    input: '37 25% 85%',
    ring: '43 64% 69%',
    sidebarBackground: '37 62% 88%',
    sidebarForeground: '37 50% 18%',
    sidebarPrimary: '43 64% 69%',
    sidebarPrimaryForeground: '37 50% 18%',
    sidebarAccent: '37 55% 82%',
    sidebarAccentForeground: '37 50% 15%',
    sidebarBorder: '37 40% 78%',
    sidebarRing: '43 64% 69%',
  ...
  },
  {
    ...
    input: '216 15% 85%',
    ring: '0 0% 85%',
    sidebarBackground: '216 33% 90%',
    sidebarForeground: '216 35% 18%',
    sidebarPrimary: '0 0% 85%',
    sidebarPrimaryForeground: '216 35% 18%',
    sidebarAccent: '216 28% 84%',
    sidebarAccentForeground: '216 30% 15%',
    sidebarBorder: '216 20% 80%',
    sidebarRing: '0 0% 85%',
  ...
  },
  {
    ...
    primary: '240 67% 94%',
    primaryForeground: '240 30% 22%',
    accent: '45 33% 95%',
    accentForeground: '240 30% 18%',
    background: '240 50% 97%',
    ...
    input: '240 18% 87%',
    ring: '240 40% 70%',
    sidebarBackground: '240 67% 94%',
    sidebarForeground: '240 30% 20%',
    sidebarPrimary: '240 40% 70%',
    sidebarPrimaryForeground: '0 0% 100%',
    sidebarAccent: '240 50% 88%',
    sidebarAccentForeground: '240 30% 18%',
    sidebarBorder: '240 30% 84%',
    sidebarRing: '240 40% 70%',
  ...
  },
  {
    ...
    input: '0 18% 87%',
    ring: '0 40% 65%',
    sidebarBackground: '0 52% 85%',
    sidebarForeground: '0 40% 18%',
    sidebarPrimary: '0 40% 65%',
    sidebarPrimaryForeground: '0 0% 100%',
    sidebarAccent: '0 45% 79%',
    sidebarAccentForeground: '0 40% 15%',
    sidebarBorder: '0 30% 76%',
    sidebarRing: '0 40% 65%',
  ...
  },
  {
    ...
    input: '160 12% 86%',
    ring: '160 30% 60%',
    sidebarBackground: '160 28% 94%',
    sidebarForeground: '160 25% 16%',
    sidebarPrimary: '160 30% 60%',
    sidebarPrimaryForeground: '0 0% 100%',
    sidebarAccent: '160 22% 88%',
    sidebarAccentForeground: '160 25% 14%',
    sidebarBorder: '160 18% 84%',
    sidebarRing: '160 30% 60%',
