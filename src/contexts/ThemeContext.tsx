...
export const themes: AppTheme[] = [
  ...
  },
  {
    ...
    sidebarForeground: '16 40% 90%',
    sidebarPrimary: '16 58% 59%',
    sidebarPrimaryForeground: '0 0% 100%',
    sidebarAccent: '105 15% 26%',
    sidebarAccentForeground: '16 40% 90%',
  ...
  },
  {
    ...
    sidebarForeground: '152 40% 88%',
    sidebarPrimary: '152 56% 78%',
    sidebarPrimaryForeground: '220 37% 14%',
    sidebarAccent: '220 30% 22%',
    sidebarAccentForeground: '152 40% 88%',
  ...
  },
  {
    ...
    sidebarForeground: '290 30% 90%',
    sidebarPrimary: '290 30% 78%',
    sidebarPrimaryForeground: '274 75% 18%',
    sidebarAccent: '274 60% 30%',
    sidebarAccentForeground: '290 30% 90%',
  ...
  },
  {
    ...
    sidebarForeground: '199 35% 88%',
    sidebarPrimary: '199 47% 69%',
    sidebarPrimaryForeground: '25 14% 14%',
    sidebarAccent: '25 12% 24%',
    sidebarAccentForeground: '199 35% 88%',
  ...
  },
  {
    ...
    ring: '76 100% 47%',
    sidebarBackground: '0 0% 12%',
    sidebarForeground: '76 50% 85%',
    sidebarPrimary: '76 100% 47%',
    sidebarPrimaryForeground: '0 0% 10%',
    sidebarAccent: '0 0% 18%',
    sidebarAccentForeground: '76 50% 85%',
    sidebarBorder: '0 0% 22%',
  ...
  },
  {
    ...
    sidebarForeground: '43 35% 88%',
    sidebarPrimary: '43 42% 57%',
    sidebarPrimaryForeground: '275 100% 12%',
    sidebarAccent: '275 80% 24%',
    sidebarAccentForeground: '43 35% 88%',
  ...
  },
  {
    ...
    sidebarForeground: '37 50% 90%',
    sidebarPrimary: '37 69% 88%',
    sidebarPrimaryForeground: '181 61% 10%',
    sidebarAccent: '181 50% 18%',
    sidebarAccentForeground: '37 50% 90%',
  ...
  },
  {
    ...
    sidebarForeground: '45 40% 88%',
    sidebarPrimary: '45 58% 52%',
    sidebarPrimaryForeground: '350 77% 12%',
    sidebarAccent: '350 60% 22%',
    sidebarAccentForeground: '45 40% 88%',
  ...
  },
  {
    ...
    sidebarForeground: '35 30% 88%',
    sidebarPrimary: '35 36% 52%',
    sidebarPrimaryForeground: '218 75% 10%',
    sidebarAccent: '218 60% 20%',
    sidebarAccentForeground: '35 30% 88%',
  ...
  },
  {
    ...
    ring: '350 28% 59%',
    sidebarBackground: '0 0% 11%',
    sidebarForeground: '350 25% 88%',
    sidebarPrimary: '350 28% 59%',
    sidebarPrimaryForeground: '0 0% 100%',
    sidebarAccent: '0 0% 18%',
    sidebarAccentForeground: '350 25% 88%',
    sidebarBorder: '0 0% 20%',
