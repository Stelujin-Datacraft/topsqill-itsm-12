  ...
  return (
    <Popover>
      ...
      <PopoverContent side="right" align="end" className="w-56 p-2">
        <p className="text-xs font-semibold text-muted-foreground px-2 pb-2">Select Theme</p>
        <div className="space-y-1">
          {themes.map((theme) => (
            <button
              ...
              className={cn(
                "w-full flex items-center gap-3 rounded-md px-2 py-2 text-left text-sm transition-colors hover:bg-muted",
