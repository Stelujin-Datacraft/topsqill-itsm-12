...
export function FormsList() {
  ...
  const renderGridView = () => <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      return <Card key={form.id} className="hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                <div className="flex space-x-1">
                  <Button variant="ghost" size="sm" onClick={() => handleViewForm(form.id)} title="Preview Form">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => handleFormAccess(form.id)} title="User Access">
                    <User className="h-4 w-4" />
                  </Button>
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="ghost" size="sm" onClick={() => handleFormSettings(form.id)} disabled={editButtonState.disabled}>
            ...
            <CardContent>
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                ...
                <div className="flex items-center space-x-2">
                  {form.status && <Badge variant={form.status === 'active' ? 'default' : 'secondary'}>
                      {form.status}
                    </Badge>}
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => navigate(`/form/${form.id}/share`)} title="Share Form">
  ...
  const renderKanbanView = () => {
    ...
    return <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {statusColumns.map(status => <div key={status.key} className="space-y-4">
