...
export function FormsList() {
  ...
  {form.isPublic ? 'Public' : ''}
                ...
                <div className="flex space-x-1">
                  <Button variant="ghost" size="sm" onClick={() => handleCopyId(form.id)} title="Copy Form ID" className="text-primary hover:text-accent hover:bg-accent/10">
                    <Copy className="h-4 w-4" />
                  </Button>
                  <Button variant="ghost" size="sm" onClick={() => handleViewForm(form.id)} title="Add Record" className="text-primary hover:text-accent hover:bg-accent/10">
                    <Plus className="h-4 w-4" />
                  </Button>
                  <Button variant="ghost" size="sm" onClick={() => handleViewRecords(form.id)} title="View Records" className="text-primary hover:text-accent hover:bg-accent/10">
                    <Database className="h-4 w-4" />
                  </Button>
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="ghost" size="sm" onClick={() => handleEditForm(form.id)} disabled={editButtonState.disabled} className="text-primary hover:text-accent hover:bg-accent/10">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="ghost" size="sm" onClick={() => handleDeleteForm(form.id)} disabled={deleteButtonState.disabled} className="text-primary hover:text-accent hover:bg-accent/10">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between gap-1">
                          <div className="flex gap-1">
                            <Button variant="ghost" size="sm" onClick={() => handleCopyId(form.id)} title="Copy Form ID" className="h-8 w-8 p-0 text-primary hover:text-accent hover:bg-accent/10">
                              <Copy className="h-3 w-3" />
                            </Button>
                            <Button variant="ghost" size="sm" onClick={() => handleViewForm(form.id)} title="Add Record" className="h-8 w-8 p-0 text-primary hover:text-accent hover:bg-accent/10">
                              <Plus className="h-3 w-3" />
                            </Button>
                            <Button variant="ghost" size="sm" onClick={() => handleViewRecords(form.id)} className="h-8 w-8 p-0 text-primary hover:text-accent hover:bg-accent/10">
                              <Database className="h-3 w-3" />
                            </Button>
                            <TooltipProvider>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="sm" onClick={() => handleEditForm(form.id)} disabled={editButtonState.disabled} className="h-8 w-8 p-0 text-primary hover:text-accent hover:bg-accent/10">
                          ...
                          <div className="flex gap-1">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="sm" onClick={() => handleDeleteForm(form.id)} disabled={deleteButtonState.disabled} className="h-8 w-8 p-0 text-primary hover:text-accent hover:bg-accent/10">
