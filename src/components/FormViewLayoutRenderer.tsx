      ...
      <div className={`print:col-span-1 ${navigationVisible && showNavigation ? "lg:col-span-3" : "lg:col-span-4"} h-full overflow-hidden flex flex-col`}>
        <Card className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-gray-950">
          ...
          <CardContent className="p-0 flex-1 overflow-y-auto min-h-0">
            ...
            {pages.length > 1 && (
              <div className="px-6 md:px-10 lg:px-16 py-4 bg-white dark:bg-gray-950 border-b border-slate-100 dark:border-slate-800">
                <FormPagination
                  pages={pages}
                  currentPageId={currentPageId}
            ...
            {/* Form Fields Section */}
            <div className="relative">
              <div className="px-6 md:px-10 lg:px-16 py-4 bg-white dark:bg-gray-950">
            ...
            {/* Action Buttons */}
            <div className="px-6 md:px-10 lg:px-16 py-8 bg-slate-50/40 dark:bg-gray-900/20">
