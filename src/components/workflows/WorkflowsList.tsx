        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center space-y-4">
              <FileText className="h-12 w-12 text-module-workflows mx-auto" />
              <div>
              ...
              <Card key={workflow.id} className="hover:shadow-md transition-shadow">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex space-x-1">
                      ...
                      >
                        <Copy className="h-4 w-4 text-module-workflows" />
                      </Button>
                      <ShareLinkButton 
                        assetType="workflow" 
                        assetId={workflow.id} 
                      ...
                      <Button
                        ...
                        title="View Workflow"
                      >
                        <Eye className="h-4 w-4 text-module-workflows" />
                      </Button>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <Edit className="h-4 w-4 text-module-workflows" />
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent>
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <Trash2 className="h-4 w-4 text-module-workflows" />
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent>
                ...
                <CardContent>
                  ...
                  {workflow.status === 'draft' && !editButtonState.disabled && (
                    ...
                    >
                      <Play className="h-4 w-4 mr-2 text-module-workflows" />
                      Activate Workflow
                    </Button>
                  )}
                  ...
                  {workflow.status === 'active' && !editButtonState.disabled && (
                    ...
                    >
                      <Pause className="h-4 w-4 mr-2 text-module-workflows" />
                      Deactivate Workflow
                    </Button>
                  )}
