...
export function EnhancedFormAccessManager({ formId, formName }: EnhancedFormAccessManagerProps) {
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Manage access to "{formName}" - permissions are determined by user roles
          </p>
        </CardHeader>
...
function UserAccessRow({ 
  ...
  const permissions = getUserPermissions('forms', formId);
  const topLevel = topLevelPermissions.forms;
    ...
    <div className="border rounded-lg">
      ...
      {expanded && (
        <div className="border-t bg-gray-50 p-4">
          <div className="space-y-3">
            <div className="text-sm font-medium">Form Permissions</div>
            
            {/* Top-level permission info */}
            <div className="text-xs text-muted-foreground bg-white p-2 rounded">
              <strong>Top-level Form Access:</strong> 
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { id: 'view', label: 'View Form', checked: permissions.view },
                { id: 'edit', label: 'Edit Form', checked: permissions.edit },
                { id: 'create', label: 'Create Form', checked: permissions.create },
                { id: 'delete', label: 'Delete Form', checked: permissions.delete }
              ].map((perm) => (
