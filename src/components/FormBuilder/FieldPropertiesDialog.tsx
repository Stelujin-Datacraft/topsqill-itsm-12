  ...
  return <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-white">
        ...
        {loadingFieldData ? <div className="flex items-center justify-center py-8">
            ...
            {!['header', 'description', 'section-break', 'horizontal-line', 'rich-text', 'file', 'signature', 'record-table', 'matrix-grid', 'cross-reference', 'full-width-container', 'address', 'currency', 'multi-select', 'tags', 'submission-access'].includes(fieldForConfig?.type || '') && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
