...
export interface ReportsListProps {
  ...
  onCreate: () => void;
  getPermissions?: (report: Report) => { canEdit: boolean; canDelete: boolean; canView: boolean };
}

export function ReportsList({ reports = [], onView, onEdit, onDelete, onCreate, getPermissions }: ReportsListProps) {
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex space-x-1">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleAccessManagement(report)}
                        title="Manage Access"
                      >
