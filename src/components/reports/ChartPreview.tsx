              ...
              <ResponsiveContainer width="100%" height="100%">
                <RechartsLineChart data={sortedData} margin={{ top: 20, right: 30, left: 60, bottom: 60 }}>
                  ...
                  <YAxis 
                    ...
                    tick={{ fontSize: 11 }}
                    domain={yDomain}
                    label={{ value: field2Name, angle: -90, position: 'insideLeft', offset: 10, style: { textAnchor: 'middle', fontWeight: 500, fill: 'hsl(var(--foreground))' } }}
                  />
                  {compareTooltip}
                ...
                bottom: 80
                  ...
                  <YAxis 
                    ...
                    label={{
                      ...
                      position: 'insideLeft',
                      offset: 10,
                      style: { textAnchor: 'middle', fontWeight: 500, fill: 'hsl(var(--foreground))' }
                    }}
                  />
                   <Tooltip 
              ...
              <ResponsiveContainer width="100%" height="100%">
                <RechartsScatterChart margin={{ top: 20, right: 30, left: 80, bottom: 80 }}>
                    ...
                    <YAxis 
                      ...
                      label={{ value: bubbleYLabel, angle: -90, position: 'insideLeft', offset: 10, style: { textAnchor: 'middle', fontWeight: 500, fill: 'hsl(var(--foreground))' } }}
