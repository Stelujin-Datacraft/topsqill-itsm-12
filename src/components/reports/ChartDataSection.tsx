...
export function ChartDataSection({ config, formFields, onConfigChange }: ChartDataSectionProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* STEP 2: Select Values (only for Calculate and Compare modes) */}
      {mode !== 'count' && (
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-base">
                  {mode === 'calculate' ? 'Select the value to calculate' : 'Select two fields to compare'}
                </CardTitle>
                <CardDescription className="text-xs mt-0.5">
                  {mode === 'calculate' 
      ...
      {/* STEP 3 (or 2 for Count mode): Group By */}
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-full bg-primary text-primary-foreground text-sm font-bold shrink-0">
