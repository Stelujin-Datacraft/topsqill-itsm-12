-- Name the signup default project after the organization (not "Default Project").
...
BEGIN
  ...
  -- Default project uses the organization name
  INSERT INTO public.projects (name, description, organization_id, created_by, status)
  VALUES (v_name, NULL, v_org_id, v_user_id, 'active')
